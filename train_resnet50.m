%% Load resnet50 initial parameters
% Load parameters for network initialization

trainingSetup = load("C:\Users\...\resnet50_info.mat");
%% Import data
% Import training and validation data

trainingSet = load("trainingSet.mat");
validationSet = load("validationSet.mat");
...
inputSize = [224 224 3];
augimdsTrain = augmentedImageDatastore(inputSize, trainingSet.trainingSet, 'ColorPreprocessing', 'gray2rgb', ...
    'DataAugmentation',imageAugmenter);

disp(augimdsTrain.NumObservations)

augimdsValidation = augmentedImageDatastore(inputSize, validationSet.validationSet, 'ColorPreprocessing', 'gray2rgb');
...
%% Create resnet50 via layergraph
...
resnet_alldata_aug = net;
save resnet_alldata_aug